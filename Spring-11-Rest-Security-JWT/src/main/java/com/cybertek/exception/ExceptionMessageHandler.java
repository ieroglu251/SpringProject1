...
public class ExceptionMessageHandler {
    ...
    public ResponseEntity<ResponseWrapper> serviceException(ServiceException se){
        ...
        return new ResponseEntity<>(ResponseWrapper.builder().sucess(false).code(HttpStatus.CONFLICT.value()).message(message).build(),HttpStatus.CONFLICT);
    ...
    public ResponseEntity<ResponseWrapper> accessdeniedexception(AccessDeniedException se){
        ...
        return new ResponseEntity<>(ResponseWrapper.builder().sucess(false).code(HttpStatus.FORBIDDEN.value()).message(message).build(),HttpStatus.CONFLICT);
    ...
    public ResponseEntity<ResponseWrapper> genericException(Throwable e, HandlerMethod handlerMethod) {
        ...
        return new ResponseEntity<>(ResponseWrapper.builder().sucess(false).message("Action failed: An error occurred!").code(HttpStatus.INTERNAL_SERVER_ERROR.value()).build(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
